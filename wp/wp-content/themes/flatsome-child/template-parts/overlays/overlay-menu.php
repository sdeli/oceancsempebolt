...
?>
<div id="main-menu" <?php echo esc_attr( implode( ' ', $flatsome_mobile_sidebar_classes ) ); ?>"<?php echo $flatsome_levels ? ' data-levels="' . esc_attr( $flatsome_levels ) . '"' : ''; ?>>
  <!-- <div class="main-menu__filter-btns">
    <a class="main-menu__filter-btns__btn">Menü</a>
    <a class="main-menu__filter-btns__btn active" onclick="openCategoriesMobileSidebar()">Kategóriák</a>
  </div> -->
