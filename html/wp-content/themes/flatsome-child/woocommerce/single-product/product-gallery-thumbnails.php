		...
		if ( $post_thumbnail ) :
			...
			<div class="col is-nav-selected first">
				<a>
					...
					$image     = '<img src="' . $image[0] . '" title="'. $image_alt .'" alt="' . $image_alt . '" width="' . $gallery_thumbnail['width'] . '" height="' . $gallery_thumbnail['height'] . '" class="attachment-woocommerce_thumbnail" />';
